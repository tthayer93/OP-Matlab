function [ total_cost, total_reward, tour, avoidance_map, sampling_reward ] = dual_budget_GPR( vine_distance, row_distance, reward_map, beginning, ending, reward_budget, sampling_budget, sampling_map, avoidance_map )
%DUAL_BUDGET_GPR Solves the BOOP with DM on IG using two budgets
%
%	Version: 1.0
%	Date: 03/07/2019
%	Author: Thomas Thayer (tthayer@ucmerced.edu)
%
%	This function solves the Irrigation Graph (IG) Dual Maximization (DM) Bi-Objective Orienteering Problem (BOOP) using the Greedy Partial Row (GPR) heuristic with two budgets, starting with sampling then rewards, presented in https://ieeexplore.ieee.org/abstract/document/8842839
%	Assumptions:
    ...
    while unsatisfied
        ...
        for z=1:2
            ...
            elseif z == 2
                ...
                budget = reward_budget + sampling_budget;
