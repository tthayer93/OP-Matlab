function [vertex_cluster_rewards, vertex_clusters] = OP_route_to_SCOP_expected_costs(tour, edge_list, rewards, cost_dist_type, cost_min_frac)
%OP_ROUTE_TO_SCOP_EXPECTED_COSTS Creates a SCOP from an OP route
%
%	Version: 1.0
%	Date: 12/02/20
%	Author: Thomas Thayer (tthayer@ucmerced.edu)
%
%	This function takes a route built to solve the Orienteering Problem (OP) creates a clustered Stochastic Cost Orienteering Problem (SCOP) from the route, utilizing the given edge cost as the expected cost.
%	Assumptions:
%		
%	Inputs:
